(custom-set-variables
 ...
 '(package-selected-packages
   '(citar ripgrep project ibuffer-project gnu-elpa-keyring-update ts-fold vc-use-package tree-sitter-ess-r imenu-anywhere flimenu imenu-list diredfl modus-themes dashboard indent-guide highlight-indent-guides copilot quelpa-use-package quelpa diff-hl outline-minor-faces bicycle org-roam-ui rainbow-delimiters ligature nerd-icons-completion nerd-icons-ibuffer nerd-icons-ivy-rich nerd-icons-dired rainbow-mode ivy-rich magit org-roam rutils ess org org-fragtog org-modern org-appear cdlatex yasnippet ivy-prescient ivy-xref counsel company-box company-reftex company-math company-bibtex company visual-fill-column adaptive-wrap auctex doom-themes doom-modeline))
